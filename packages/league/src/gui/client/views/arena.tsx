      ...
      return (
        <div class="panel no-run">
          <div class="no-run-inner">
            ...
            <p class="lede">The external draft process is active. Start new runs after it finishes.</p>
          </div>
        </div>
      );
    }
        ...
        <div>
          ...
          {run.canControl ? (
            <div class="run-controls">
              <button type="button" class="button danger" disabled={!active || stopping} onClick={stop}>
