      ...
      <div className="path-wrap">
        <ol
          ...
          style={{
            ...
            margin: 0,
            padding: 0,
            gridTemplateColumns: `auto repeat(${seats}, minmax(7.5rem, 1fr))`,
          }}
        >
          ...
          <div>
            <div className="meta">
              ...
              <Link
                className="team-tag"
                to={`/teams/${team.id}/`}
                style={toneStyle(tone(index.get(team.id) ?? 0))}
              >
            ...
            {current.rationale ? (
              <p className="prose">{current.rationale}</p>
            ) : (
              <p className="hint">No reasoning recorded.</p>
            )}
          </div>
        </article>
      ) : null}
