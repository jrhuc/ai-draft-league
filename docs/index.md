...
This repository owns the referee, provider adapters, run artifacts, local operator tooling, and their documentation. The public [AI Draft League](https://github.com/jrhuc/ai-draft-league) spectator product consumes a validated public season bundle; it never receives private sheets or recomputes game authority.
