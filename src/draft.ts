...
const DRAFT_PROMPT_POLICY = {
  systemTemplate: [
    ...
    '- You may draft, register, and bring any number of Mega entries. One Mega Evolution is allowed per game, among the four on',
    '  the field; which of them it is, if any, is your choice in play.',
    '{{rosterPolicy}}',
